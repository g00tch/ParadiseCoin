![Graph-Logo](https://i.imgur.com/poM3qYN.png)
# ParadiseCoin Masternode Setup Guide (Ubuntu 16.04)
This guide will assist you in setting up a ParadiseCoin Masternode on a Linux Server running Ubuntu 16.04. (Use at your own risk)

If you require further assistance contact the support team @ [Discord](https://discord.gg/wGpq8ND)
***
## Requirements
1) **1,000 PRD coins.**
...
***Step 1***
* Download and install the ParadiseCoin wallet on your computer [here](https://github.com/ParadiseCoin/ParadiseCoin-source-code/releases/download/1.0.3.1/ParadiseCoin-qt-windows.zip)
***

***Step 2***
* Send EXACLY 1,000 PRD to a receive address within your wallet.
***
...
`ParadiseCoin-cli masternode status`

`ParadiseCoin-cli getinfo`
